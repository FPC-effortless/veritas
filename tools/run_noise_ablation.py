...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run CompanyWorld diagnostic noise/conflict ablation")
    ...
    from investigation_world.calibration.noise_ablation import run_diagnostic_noise_ablation
    ...
    def generate(prompt: str) -> str:
        nonlocal calls, generation_seconds
        messages = [
    ...
    report = run_diagnostic_noise_ablation(
        generate,
