...
def attribute_drift(
    ...
    *,
    ...
    # Propagate prerequisite regressions upward through the declared dependency structure.
    ...
    # Candidate roots are directly regressed nodes without directly regressed prerequisites.
...
def companyworld_investigation_capability_graph() -> CapabilityGraph:
    """Initial CompanyWorld diagnostic dependency graph over verifier-visible dimensions."""
