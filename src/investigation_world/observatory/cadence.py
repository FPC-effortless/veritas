...
class CadencedObservationRunner:
    ...
    This class intentionally does not own a background thread or remote scheduler. It provides
    deterministic due-state and checkpoint semantics so cron, GitHub Actions, a service scheduler,
    or another orchestrator can invoke the same operation safely.
    """
